...
('2465',
 'NVIDIA 顯示卡代理商轉型地端 AI 方案：工作站、AI 伺服器、液冷',
 '已成主業',
 '從以 GPU 代理銷售為主，轉向企業與政府的**地端 AI** 解決方案，'
 '產品線延伸到 AI 工作站、AI 伺服器，以及水冷／液冷設備。'
 '2026 上半年合併營收 **40.75 億、年增 158%**，6 月單月 9.38 億、年增 **543%**。',
 '**代理的成分還在。** 地端 AI 工作站的需求跟雲端資本支出不是同一條線，'
 '它靠的是企業與政府自建，量體比雲端小得多、而且採購是專案制、'
 '會有大小月。另外 543% 是低基期，看的要是絕對金額不是年增率。',
 '伺服器組裝・液冷',
 '麗臺法說會（2025-12-19）／台視財經／鉅亨網營收速報／MoneyDJ',
 date '2026-09-11'),

('3515',
 '主機板廠變成 AI 基礎設施供應商：伺服器營收比重 10% → 逾五成',
 '已成主業',
 '伺服器營收比重從 **10% → 22% → 目前逾五成**，2025 全年營收 478 億、'
 '年增 86%，動能來自 AI 伺服器與顯示卡。'
 '子公司**永擎**（AI 伺服器）2026Q1 營收 88.9 億、年增 **92%**。',
 '**它的「伺服器」不全是 AI 伺服器**，還有工業電腦與一般伺服器，'
 '而且顯示卡（VGA）那一塊跟著消費與挖礦需求走，跟 AI 資本支出是兩個循環。'
 '主機板本業仍在，毛利結構跟純 AI 伺服器代工廠不一樣。',
 '伺服器組裝',
 '華擎法說會（2026-03-06、2026-06-18）／鉅亨網產業研究報告／CMoney',
 date '2026-09-11'),
